...
async function main() {
  ...
  const santriList = [
    {
      nis: '202601001',
      nfcUid: 'NFC-8A3F129B',
      nama: 'Muhammad Azzam Al-Fatih',
      gender: 'L',
      kelas: '10 IPA (KMI 4)',
      kamar: 'Asrama Umar bin Khattab No. 04',
      alamat: 'Sumbersari, Kencong, Kepung, Kediri, Jawa Timur',
  ...
  const settingsData = [
    { key: 'NAMA_LEMBAGA', value: 'Pondok Pesantren Darul Rahman Sumbersari' },
    { key: 'TAGLINE_LEMBAGA', value: 'Pondok Pesantren Salafiyah Terpadu • Kajian Kitab Kuning & Muhafadzoh Nadzoman' },
    { key: 'ALAMAT_LEMBAGA', value: 'Sumbersari, Kencong, Kepung, Kediri, Jawa Timur' },
    { key: 'NO_TELP', value: '+62 851-2373-4342' },
    { key: 'WHATSAPP_CENTER', value: '+6285123734342' },
    { key: 'EMAIL_LEMBAGA', value: 'darulrahmansumbersari@gmail.com' },
    { key: 'WEBSITE_LEMBAGA', value: 'https://darulrahman.sipesand.web.id' },
    { key: 'NAMA_KEPALA_PONDOK', value: 'K.H. Pengasuh Darul Rahman' },
    { key: 'JABATAN_PENGASUH', value: 'Pengasuh Pondok Pesantren Darul Rahman' },
    { key: 'LOKASI_PENGASUH', value: 'Kencong, Kepung, Kediri' },
    { key: 'FOTO_PENGASUH_URL', value: 'https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=600&q=80' },
    { key: 'KALAM_PENGASUH', value: 'Pondok Pesantren Darul Rahman istiqomah menjaga sanad keilmuan para ulama salafus shalih. Santri kami gembleng membaca dan memaknai kitab kuning, menghafal nadzoman kaidah bahasa dan fiqih (Imrithi & Alfiyah Ibnu Malik), serta mengasah daya nalar melalui tradisi musyawarah dan takror setiap malam. Dengan adab di atas ilmu, santri dipersiapkan menjadi pribadi yang kokoh akidahnya dan bijak dalam mengabdi di masyarakat.' },
    { key: 'STAT_1_NUMBER', value: '500+' },
    { key: 'STAT_1_LABEL', value: 'Santri Mukim' },
    { key: 'STAT_2_NUMBER', value: '1.000 Bait' },
    { key: 'STAT_2_LABEL', value: 'Nadzom Alfiyah & Imrithi' },
    { key: 'STAT_3_NUMBER', value: '18+' },
    { key: 'STAT_3_LABEL', value: 'Asatidz Pengampu Salaf' },
    { key: 'STAT_4_NUMBER', value: '100%' },
    { key: 'STAT_4_LABEL', value: 'Cashless KTSD RFID' },
    ...
    { key: 'BANK_ACCOUNT_HOLDER', value: 'YAYASAN DARUL RAHMAN SUMBERSARI' },
    { key: 'PSB_STATUS', value: 'BUKA' },
    { key: 'PSB_TAHUN', value: '2026/2027' },
    { key: 'PSB_WHATSAPP', value: '+6285123734342' },
    { key: 'PSB_DESCRIPTION', value: 'Pilar pendidikan kepesantrenan salafiyah di Darul Rahman yang menitikberatkan pada penguasaan kitab kuning, muhafadzoh nadzoman, musyawarah ilmiah, dan takror santri.' },
