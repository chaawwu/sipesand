...
export default function SettingsAndAccounts() {
  ...
  const handleImageUpload = async (key, e) => {
    ...
    try {
      ...
      // Coba simpan ke Cloudflare R2 jika aktif
      let finalUrl = compressedDataUrl;
      try {
        const uploadRes = await uploadFileToR2({
          fileName: `${key.toLowerCase()}.jpg`,
        ...
        console.info('R2 standby, fallback ke local storage:', uploadErr);
      }

      const updated = { ...formSettings, [key]: finalUrl };
