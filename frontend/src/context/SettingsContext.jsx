...
const defaultSettings = {
  ...
  JABATAN_PENGASUH: 'Pengasuh Pondok Pesantren',
  LOKASI_PENGASUH: 'Kompleks Pesantren Terpadu',
  FOTO_PENGASUH_URL: 'https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=600&q=80',
  KALAM_PENGASUH: 'Pondok Pesantren istiqomah menjaga sanad keilmuan para ulama salafus shalih. Santri kami gembleng membaca dan memaknai kitab kuning, menghafal nadzoman kaidah bahasa dan fiqih, serta mengasah daya nalar melalui tradisi musyawarah dan takror setiap malam. Dengan adab di atas ilmu, santri dipersiapkan menjadi pribadi yang kokoh akidahnya dan bijak dalam mengabdi di masyarakat.',
  STAT_1_NUMBER: '500+',
  STAT_1_LABEL: 'Santri Mukim',
  STAT_2_NUMBER: '1.000 Bait',
  STAT_2_LABEL: 'Nadzom Alfiyah & Imrithi',
  ...
  PSB_STATUS: 'BUKA',
  PSB_TAHUN: '2026/2027',
  PSB_WHATSAPP: '0812-3456-7890',
  PSB_DESCRIPTION: 'Penerimaan Santri Baru membuka pendaftaran untuk program Madrasah Diniyah Salafiyah, Muhafadzoh Nadzom Kitab, serta jenjang formal terpadu.',
  LOGO_PONDOK_URL: '',
  CAP_STEMPEL_URL: '',
  TTD_KEPALA_URL: '',
  TTD_BENDAHARA_URL: '',
